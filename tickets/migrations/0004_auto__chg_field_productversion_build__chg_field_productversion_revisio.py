...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductVersion.build'
        db.alter_column(u'tickets_productversion', 'build', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProductVersion.revision'
        db.alter_column(u'tickets_productversion', 'revision', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductVersion.build'
        db.alter_column(u'tickets_productversion', 'build', self.gf('django.db.models.fields.IntegerField')(default=-1))

        # Changing field 'ProductVersion.revision'
        db.alter_column(u'tickets_productversion', 'revision', self.gf('django.db.models.fields.IntegerField')(default=-1))
