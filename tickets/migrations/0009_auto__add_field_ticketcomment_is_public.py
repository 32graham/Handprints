...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketComment.is_public'
        db.add_column(u'tickets_ticketcomment', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketComment.is_public'
        db.delete_column(u'tickets_ticketcomment', 'is_public')
    ...
    models = {
        ...
        u'tickets.ticket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tickets.Product']", 'null': 'True', 'blank': 'True'}),
