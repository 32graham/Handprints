...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field assignees on 'Ticket'
        m2m_table_name = db.shorten_name(u'tickets_ticket_assignees')
    ...
    def backwards(self, orm):
        # Removing M2M table for field assignees on 'Ticket'
        db.delete_table(db.shorten_name(u'tickets_ticket_assignees'))
    ...
    models = {
        ...
        u'tickets.ticket': {
            ...
            'assignees': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'assignments'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
