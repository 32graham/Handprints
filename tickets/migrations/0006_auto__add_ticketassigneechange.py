...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'tickets.ticketassigneechange': {
            'Meta': {'object_name': 'TicketAssigneeChange'},
            'added': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['auth.User']"}),
