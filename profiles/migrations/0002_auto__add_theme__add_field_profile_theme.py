...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Theme'
        db.create_table(u'profiles_theme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('html', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'profiles', ['Theme'])

        # Adding field 'Profile.theme'
        db.add_column(u'profiles_profile', 'theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Theme']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Theme'
        db.delete_table(u'profiles_theme')

        # Deleting field 'Profile.theme'
        db.delete_column(u'profiles_profile', 'theme_id')
    ...
    models = {
        ...
        u'profiles.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['profiles.Theme']"}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'profiles.theme': {
            'Meta': {'object_name': 'Theme'},
            'html': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        }
    }
